	...
	<div class="container">
		...
		<c:if test="${not empty _front_user}">
			<div id="userBlock" style="float:right">
				...
				<a href="${pageContext.request.contextPath}/front/user/index.do" id="account">${sessionScope._front_user.email }</a>
			</div>
		</c:if>
		<c:if test="${empty _front_user}">
			<div id="regBlock" style="float:right">
				<a href="${pageContext.request.contextPath}/user/regist.action" id="reg_open"><img src="img/we.png">注册</a>
		...
		<a target="_blank" href="${pageContext.request.contextPath}/adminlog.action"><img src="${pageContext.request.contextPath}/img/we.png" draggable="false">后台管理</a>
