...
<html lang="zh-CN">
  ...
  <div   class="collapse navbar-collapse navbar-inverse navbar-fixed-top  row"  id="bs-example-navbar-collapse-9" >
         ...
         <a class="navbar-brand col-md-offset-5" href="#">${logAdmin.loginName}</a>  
...
<form action="${pageContext.request.contextPath}/video/addVideo.action" method="post" class="navbar-form navbar-left" role="search" style="width: 1080px;">
<table width="100%" border="0" height="400px">
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">视频标题</font></b></td>
	     	  <td width="70%"><input type="text" name="videoTitle" placeholder="视频标题" style="width: 100%;"></td>
	     </tr>
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">主讲人</font></b></td>
	     	  <td width="70%">
	     	  	               <select  name="speakerId" style="width: 100%;">	  	
	     ...
	     <tr>
	     	  ...
	     	  <td width="70%"><input type="text" name="videoLength" placeholder="视频时长(秒)" style="width: 100%;" ></td>
	     </tr>	
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">封面图片</font></b></td>
	     	  <td width="70%"><input type="text" name="videoImageUrl" placeholder="视频封面图片地址，网络图片" style="width: 100%;" ></td>
	     </tr>	
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">视频播放地址</font></b></td>
	     	  <td width="70%"><input type="text" name="videoUrl" placeholder="视频播放地址，网络地址" style="width: 100%;" ></td>
	     </tr>
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">视频简介</font></b></td>
	     	  <td width="70%">
<textarea name="videoDescr" autocomplete="on" style="width: 100%;height: 100%;"></textarea>
	     	  </td>
	     </tr>	     
