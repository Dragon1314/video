                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            ...
                            <c:if test="${not empty user.headUrl}">
                                  <img width="200px" height="200px" src="/pics/${user.headUrl}">
                            </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/front/user/avatar.do?email=${email}"  >
                                <p>请选择图像文件</p>
                                <div>
                                <input type="file" class="form-control" name="pics" id="image_file" accept="image/png,image/jpeg,image/jpg"/>
