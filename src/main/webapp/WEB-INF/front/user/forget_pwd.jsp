...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="${pageContext.request.contextPath}/front/forgetpwd.do" method="post" >
                <div class="form_header">
                    ...
                    <div class="form_back">
                        <a href="${pageContext.request.contextPath}/front/index.do">返回立即登录</a>
                    </div>
                </div>
                <div class="form_body">
                ...
                <div class="form_footer">
                    <div class="FAQ">
                        <span>收不到邮件？查看</span><a href="http://service.mail.qq.com/">常见问题</a>
                    </div>
                </div>
            </form>
        </div>
