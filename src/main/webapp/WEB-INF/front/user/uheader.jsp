...
<div class="container clearfix">
			<ul class="clearfix f_left">
				<li><a href="${pageContext.request.contextPath}/front/index.do">首页</a></li>
				<li class="menu_active"><a href="${pageContext.request.contextPath}/front/user/index.do?email=${email}">个人中心</a></li>
			</ul>
			<div id="user_bar">
				<a href="/front/user/index.action">
					...
					<c:if test="${not empty user.headUrl}">
						<img id="avatar" src="/pics/${user.headUrl}" alt="">
					</c:if>
