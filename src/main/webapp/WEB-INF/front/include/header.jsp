	...
	<div class="container">
		...
		<c:if test="${not empty user}">
			<div id="userBlock" style="float:right">
				...
				<a href="${pageContext.request.contextPath}/front/user/index.do?email=${sessionScope.user.email }" id="account">${sessionScope.user.email }</a>
			</div>
		</c:if>
		...
		<a target="_blank" href="${pageContext.request.contextPath}/admin/adminlog.action"><img src="${pageContext.request.contextPath}/img/we.png" draggable="false">后台管理</a>
