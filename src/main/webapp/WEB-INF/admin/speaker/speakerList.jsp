...
<script src="${pageContext.request.contextPath}/js/bootstrap.min.js"></script>
  ...
  <div class="container-fluid  ">
  	...
  	<jsp:param value="speaker" name="jsp"/>
  	</jsp:include>  	
...
<form action="${pageContext.request.contextPath}/admin/speaker/speakerList.action" method="post" class="navbar-form navbar-left " role="search" style="width: 1080px;">
     <div class="form-group" style="width: 1080px;">
       <a href="${pageContext.request.contextPath}/admin/speaker/addSpeaker.action" class="btn btn-primary navbar-btn" >添加主讲人</a>
...
<c:forEach items="${page.rows}" varStatus="status" var="speaker">
    <tr>
     <th width="10%">${status.count}</th>
 	 ...
 	 <th width="10%"><a href="${pageContext.request.contextPath}/admin/speaker/editSpeaker.action?upid=${speaker.id}"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></th>
 	 <th width="10%"><a onclick="del('${pageContext.request.contextPath}/admin/speaker/deleteSpeaker.action?delid=${speaker.id}')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></th>   	   	
    </tr>
</c:forEach>   
...
function suburl(){
 ...
 <x:page url="${pageContext.request.contextPath}/admin/speaker/speakerList.action"></x:page>
