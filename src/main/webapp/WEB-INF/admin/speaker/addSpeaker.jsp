...
<form action="${pageContext.request.contextPath}/admin/speaker/addSpeaker.action" method="post" class="navbar-form navbar-left form-group has-success" role="search" style="width: 1080px;">
<table width="100%" border="0" height="400px">
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">名字</font></b></td>
	     	  <td width="70%"><input  type="text"  placeholder="主讲人名字"  style="width: 100%;" name="speakerName"></td>
	     </tr>

	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">职业</font></b></td>
	     	  <td width="70%"><input type="text" placeholder="主讲人职业" style="width: 100%;" name="speakerJob"></td>
	     </tr>	
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">头像图片</font></b></td>
	     	  <td width="70%"><input type="text" placeholder="主讲人头像地址，网络图片" style="width: 100%;" name="speakerHeadUrl"></td>
	     </tr>	
	
	     <tr>
	     	  <td width="30%" align="center"><b><font size="4" class="">简介</font></b></td>
	     	  <td width="70%">
<textarea  style="width: 100%;height: 100%;" name="speakerDescr"></textarea>
	     	  </td>
	     </tr>	     
