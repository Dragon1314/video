...
<%--           <div   class="collapse navbar-collapse navbar-inverse navbar-fixed-top  row"  id="bs-example-navbar-collapse-9" >
   ...
   <div class="col-md-offset-2 col-md-9 form-group " style="width: 1080px;">
          <form class="navbar-form navbar-left" role="search" style="width: 1080px;" action="${pageContext.request.contextPath}/admin/video/videoList.action" method="post">
                     <div class="form-group" style="width: 1080px;">
                                 <a href="${pageContext.request.contextPath}/admin/video/addVideo.action" class="btn btn-primary navbar-btn  active " >添加视频</a>
...
<form action="${pageContext.request.contextPath}/admin/video/deleteVideos.action"> 
...
<textarea   readonly="readonly" rows="3"  style="width: 100%;resize: none;border-style: none;background: transparent;overflow: hidden;">${video.videoDescr}</textarea>
     ...
     <th width="5%">${video.videoPlayTimes}</th>
 	 <th width="5%"><a href="${pageContext.request.contextPath}/admin/video/editVideo.action?upid=${video.id}"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></th>
<%--  	 <th width="5%"><a data-toggle="modal" data-target="#myModal" href="${pageContext.request.contextPath}/video/deleteVideo.action?delid=${video.id}"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></th> --%>
  	 <th width="5%"><a  onclick="del('${pageContext.request.contextPath}/admin/video/deleteVideo.action?delid=${video.id}')" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></th>
 </tr>
