...
<div class="container">
  ...
  <form  action="${pageContext.request.contextPath}/admin/adminLogin.action" method="post" id="loginForm">		 
  <div class="form-group has-success "  class="col-md-3">
  	<img src="${pageContext.request.contextPath}/img/logo.png" width="250px" /><br />
