...
<form action="${pageContext.request.contextPath}/speaker/addSpeaker.action" method="post" class="navbar-form navbar-left form-group has-success" role="search" style="width: 1080px;">
